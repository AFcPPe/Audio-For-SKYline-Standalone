	...
	if (Global::get().s.bDeaf) {
		...
		switch (p->tsState) {
			...
			case Settings::MutedTalking:
				...
				qlbTX1->setStyleSheet("background-color: rgb(131, 213, 0);color: white;font: 12px \"Microsoft YaHei\";");
			...
			default:
				qlbTX1->setStyleSheet("background-color: rgb(0, 0, 0);color: white;font: 12px \"Microsoft YaHei\";");
...
void MainWindow::on_qaServerConnect_triggered(bool autoconnect) {
	...
	if (res == QDialog::Accepted) {
		...
		QJsonArray arr        = data["pilotList"].toArray();
		bool found            = false;
...
void MainWindow::userStateChanged() {
	...
	switch (user->tsState) {
		...
		case Settings::Shouting:
			...
			//qlbRX1->setStyleSheet("background-color: rgb(131, 213, 0);color: white;font: 12px \"微软雅黑\";");
		...
		default:
			Global::get().bAttenuateOthers              = false;
			Global::get().prioritySpeakerActiveOverride = false;
			//qlbRX1->setStyleSheet("background-color: rgb(0, 0, 0);color: white;font: 12px \"微软雅黑\";");
			break;
	}
}
