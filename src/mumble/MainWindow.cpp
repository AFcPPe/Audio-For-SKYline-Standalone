	...
	if (Global::get().s.bDeaf) {
		...
		switch (p->tsState) {
			...
			case Settings::MutedTalking:
				...
				qlbTX1->setStyleSheet("background-color: rgb(131, 213, 0);color: white;font: 12px \"微软雅黑\";");
			...
			default:
				qlbTX1->setStyleSheet("background-color: rgb(0, 0, 0);color: white;font: 12px \"微软雅黑\";");
				Global::get().bTalking = false;
