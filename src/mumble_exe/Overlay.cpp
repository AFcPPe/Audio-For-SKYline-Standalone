...
//
// When running in "AudioForSkyline.dll"-mode, it's convenient for this symbol to be
// defined here in mumble.exe (alongside the symbol in AudioForSkyline.dll) because that
// allows older versions of mumble_ol.dll that are not "AudioForSkyline.dll"-aware at all
